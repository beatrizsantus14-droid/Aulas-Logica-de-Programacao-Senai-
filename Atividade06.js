...
//e
console.log(`Sistema ativo ${sistemaAtivo}, modo manutencao ${modoManutencao}, lugar vago ${lugarVago}, lugar ocupado ${lugarOcupado}`)
...
console.log(`IMC normal do peso: ${imcNormal}`)
...
let valor = lerTeclado.keyInYN("Paga mais de R$1000,00?")
//c
